...
from e2b_aider_generator import CodeGenerationResult, E2BAiderClient
...
class TestE2BAiderClient(unittest.TestCase):
    ...
    def test_install_aider(self):
        ...
        expected_calls = [
            unittest.mock.call("pip install aider-chat"),
            unittest.mock.call("pip install openai")
        ]
    ...
    def test_run_aider_prompt(self):
        ...
        mock_result = Mock()
        mock_result.exit_code = 0
        mock_result.stdout = "Aider output"
        mock_result.stderr = ""
        mock_commands.run.return_value = mock_result
        mock_sandbox.commands = mock_commands
        ...
        self.assertIn("Aider output", result)
    ...
    def test_run_aider_prompt_error(self):
        ...
        mock_result.stderr = "Aider execution failed"
        mock_commands.run.return_value = mock_result
        mock_sandbox.commands = mock_commands
        ...
        self.assertIn("Aider execution failed", result)
    ...
    def test_get_generated_files(self):
        ...
        # Mock cat commands
        cat_result1 = Mock()
        cat_result1.exit_code = 0
        cat_result1.stdout = 'print("hello")'
        
        cat_result2 = Mock()
        cat_result2.exit_code = 0
        cat_result2.stdout = '# Project'
        
        mock_commands.run.side_effect = [find_result, cat_result1, cat_result2]
        mock_sandbox.commands = mock_commands
